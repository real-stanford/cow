...
from src.shared.utils import get_open_x_displays


class ObjectNavThorBaseConfig(BaseConfig, ABC):
    ...
    def env_args(cls):
        ...
        return dict(
            ...
            renderDepthImage=any(isinstance(s, DepthSensorThor)
    ...
    def test_task_sampler_args(
        ...
        if self.test_on_validation or self.TEST_DATASET_DIR is None:
            ...
            res["rewards_config"] = {
                **res["rewards_config"], "shaping_weight": 0}

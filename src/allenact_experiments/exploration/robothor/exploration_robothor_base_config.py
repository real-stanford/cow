# modified from: https://github.com/allenai/allenact/blob/main/projects/objectnav_baselines/experiments/robothor/objectnav_robothor_base.py
...
from src.allenact_experiments.exploration.robothor.exploration_thor_base_config import ExplorationThorBaseConfig


class ExplorationRoboThorBaseConfig(ExplorationThorBaseConfig, ABC):
    ...
    DEFAULT_NUM_TRAIN_PROCESSES = 20 if torch.cuda.is_available() else 1
    ...
    def train_task_sampler_args(
        ...
        kwargs = super(ExplorationRoboThorBaseConfig, self).train_task_sampler_args(
